            ...
            <div className="sm:text-center lg:text-left">
                ...
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:flex lg:justify-start">
                    <div className="md:m-1">
                        <Link to="" className="flex mb-2 font-semibold justify-center rounded-md bg-green-500 text-white px-8 py-4 hover:bg-green-600 transition duration-300">View properties</Link>
                    </div>
                    <div className="md:m-1">
                        <Link to="" className="flex mb-2 font-semibold justify-center rounded-md bg-green-200 text-green-700 px-8 py-4 hover:bg-green-300 transition duration-300">Explore Locations</Link>
                    </div>
                </div>
            </div>
        </main>
